...
export function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[9999] group flex items-center gap-0 rounded-full text-white transition-all duration-300 ease-out"
      style={{
        background: '#25D366',
        boxShadow: '0 4px 20px rgba(37, 211, 102, 0.45)',
      }}
    >
      {/* Label: visible en desktop, oculto en mobile */}
      <span
        className="
          hidden sm:block
